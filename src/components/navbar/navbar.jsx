   ...
   const [open, setOpen] = useState(false)
    ...
    return(
        ...
        <div className="nav-top container d-flex align-items-center justify-content-between">
          <div className="logo text-white fw-bold"><img className='logo' src="/systemlogo.png" alt="" /></div>
          ...
          <div className="container text-white py-5">
            <div className="row">
              ...
              <div className="col-md-3">
                ...
                <div className="item">
                  <span><img src="/Navbar/Vector.png" alt="" /></span>
                  <div>
                ...
                <div className="item">
                  <span><img src="/Navbar/Vector1.png" alt="" /></span>
                  <div>
                ...
                <div className="item">
                  <span><img src="/Navbar/Vector2.png" alt="" /></span>
                  <div>
              ...
              <div className="col-md-3">
                ...
                <div className="item">
                  <span><img src="/Navbar/Vectors.png" alt="" /></span>
                  <div>
                ...
                <div className="item">
                  <span><img src="/Navbar/atendimento.png" alt="" /></span>
                  <div>
                ...
                <div className="item">
                  <span><img src="/Navbar/resultado.png" alt="" /></span>
                  <div>
                ...
                <div className="item">
                  <span><img src="/Navbar/portfolio.png" alt="" /></span>
                  <div>
              ...
              <div className="col-md-3">
                ...
                <div className="item">
                  <span><img src="/Navbar/fale.png" alt="" /></span>
                  <div>
                ...
                <div className="item">
                  <span><img src="/Navbar/quem.png" alt="" /></span>
                  <div>
                ...
                <div className="item">
                  <span><img src="/Navbar/missao.png" alt="" /></span>
                  <div>
                ...
                <div className="item">
                  <span><img src="/Navbar/valores.png" alt="" /></span>
                  <div>
              ...
              <div className="col-md-3">
                ...
                <div className="item">
                  <span><img src="/Navbar/blog.png" alt="" /></span>
                  <div>
                    <strong>Blog</strong>
                ...
                <div className="item">
                  <span><img src="/Navbar/faq.png" alt="" /></span>
                  <div>
                    <strong>FAQ</strong>
                    <p>Tendências e tecnologia</p>
                  </div>
                ...
                <div className="item">
                  <span><img src="/Navbar/doc.png" alt="" /></span>
                  <div>
